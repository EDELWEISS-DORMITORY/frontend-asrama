    ...
    <>
      ...
      <section className="bg-white border border-slate-200 rounded-2xl overflow-hidden mb-6" aria-label="Navigasi fitur check point">
        <div className="flex overflow-x-auto" role="tablist" aria-label="Navigasi modul check point">
          <button id="tab-jadwal" type="button" role="tab" aria-selected={activeTab === "jadwal"} aria-controls="section-jadwal" tabIndex={activeTab === "jadwal" ? 0 : -1} data-section="jadwal" onClick={() => handleTabChange("jadwal")} className={activeTab === "jadwal" ? activeTabClass : inactiveTabClass}>
            <i className="fa-solid fa-calendar-days mr-2" aria-hidden="true"></i>
            Jadwal Check Point
          </button>
          <button id="tab-input" type="button" role="tab" aria-selected={activeTab === "input"} aria-controls="section-input" tabIndex={activeTab === "input" ? 0 : -1} data-section="input" onClick={() => handleTabChange("input")} className={activeTab === "input" ? activeTabClass : inactiveTabClass}>
            <i className="fa-solid fa-clipboard-check mr-2" aria-hidden="true"></i>
            Input Kehadiran
          </button>
          <button id="tab-hasil" type="button" role="tab" aria-selected={activeTab === "hasil"} aria-controls="section-hasil" tabIndex={activeTab === "hasil" ? 0 : -1} data-section="hasil" onClick={() => handleTabChange("hasil")} className={activeTab === "hasil" ? activeTabClass : inactiveTabClass}>
            <i className="fa-solid fa-chart-line mr-2" aria-hidden="true"></i>
            Hasil Check Point
          </button>
          <button id="tab-pelanggaran" type="button" role="tab" aria-selected={activeTab === "pelanggaran"} aria-controls="section-pelanggaran" tabIndex={activeTab === "pelanggaran" ? 0 : -1} data-section="pelanggaran" onClick={() => handleTabChange("pelanggaran")} className={activeTab === "pelanggaran" ? activeTabClass : inactiveTabClass}>
      ...
      {activeTab === "jadwal" && <JadwalCheckPointView onOpenTab={handleTabChange} setModalOpen={setIsModalOpen} />}
